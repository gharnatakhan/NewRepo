...
public class SalesAdministrator extends AccountManager {
	...
	public SalesAdministrator(String firstName, String lastName, String email,  String photoPath,
			String password, int phoneNumber, List<JobPosting> jobPostings, List<Client> clients) {
		super(firstName, lastName, email, photoPath, password, phoneNumber, jobPostings, clients);
		// TODO Auto-generated constructor stub
	}
