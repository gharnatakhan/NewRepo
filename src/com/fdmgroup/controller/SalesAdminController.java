...
public class SalesAdminController {
	...
	@RequestMapping(value="/applicationHistory/{id}")
	public String findTraineeApplicationHistory(@PathVariable int id, HttpSession session, Model model) {
		// need a condition that if the trainee name is equal to the name input 
		UserDao userDao = new UserDao();
		List<Application> listOfApplicationHistories = userDao.findApplicationsByTraineeId(id);
